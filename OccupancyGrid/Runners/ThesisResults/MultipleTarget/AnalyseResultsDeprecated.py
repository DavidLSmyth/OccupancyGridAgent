...
for search_strategy in search_strategies:
    for source_no in no_sources:
        try:
            ...
            expected_time_to_decision_two_pos = np.mean(two_pos_data['TTD'])
            expected_time_to_decision_one_pos = np.mean(one_pos_data['TTD'])
            expected_time_to_decision_zero_pos = np.mean(zero_pos_data['TTD'])
            
            sd_ttd = np.std(all_data['TTD'])
            sd_ttd_two_pos = np.std(two_pos_data['TTD'])
            sd_ttd_one_pos = np.std(one_pos_data['TTD'])
            sd_ttd_zero_pos = np.std(zero_pos_data['TTD'])
