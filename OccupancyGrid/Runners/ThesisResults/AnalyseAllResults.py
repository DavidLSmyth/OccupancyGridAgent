    ...
    for variable_param in list(os.walk(base_dir+'/'+subdir))[0][1]:
        for search_strategy in search_strategies:
            ...
            try:
                ...
                #label = 'Total Number of guesses at Target Location'
                ...
                #    plot_data = [all_data[all_data['NoGuesses'] == 3]['TTD'], all_data[all_data['NoGuesses'] == 2]['TTD'], all_data[all_data['NoGuesses'] == 1]['TTD']]
                ...
                plt.savefig("D:\\OccupancyGrid\\OccupancyGrid\\Runners\\ThesisResults\\Histograms\\{}{}Histogram.png".format(variable_param, search_strategy))
                plt.close()
