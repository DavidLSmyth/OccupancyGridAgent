...
#    agent3_name = 'agent3'
    ...
    print("Running sim with {} sensor fpr".format(sensor_model_fpr))
    print("Running sim with {} sensor fnr".format(sensor_model_fnr))
    ...
    if prior == 'Gaussian':
        initial_belief = generate_gaussian_prior(grid, [source_locations[0].x_val, source_locations[0].y_val], covariance_matrix, initial_belief_present)
    elif prior == 'Uniform':
    ...
    #%%
    results_file = "D:/OccupancyGrid/OccupancyGrid/Runners/ThesisResults/MiscalibratedSensor/{}/{}/MiscalibratedSensorProcess{}.csv".format(str(sensor_model_fpr)[2:]+'-'+str(sensor_model_fnr)[2:], search_strategy, run_no)
    covariance_matrix = [[3.0, 0], [0, 3.0]]
