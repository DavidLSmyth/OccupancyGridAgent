...
for search_strategy in search_strategies:
    for sensor_param in sensor_params:
        try:
            os.chdir("D:/OccupancyGrid/OccupancyGrid/Runners/ThesisResults/VerifyChungBurdickResults/{}/{}".format(sensor_param,search_strategy))
            csv_locs = ["VerifyChungBurdickResultsProcess{}.csv".format(i) for i in range(1, 9)]    
