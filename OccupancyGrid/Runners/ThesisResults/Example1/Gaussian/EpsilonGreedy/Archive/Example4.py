...
def main():
    random.seed(int(__file__[-4]))#args = parse_args(sys.argv[1:])
...
#    agent3_name = 'agent3'
    ...
    agent1_initial_belief_map = MultipleSourceBinaryBeliefMap(grid, gaussian_initial, agent1_sensor_model_fpr, agent1_sensor_model_fnr)
    ...
    #%%
    results_file = "D:/OccupancyGrid/OccupancyGrid/Runners/ThesisResults/Example1/GaussianPrior/Experiment1Process{}.csv".format(__file__[-4])
    covariance_matrix = [[3.0, 0], [0, 3.0]]
