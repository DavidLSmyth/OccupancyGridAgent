# -*- coding: utf-8 -*-
"""
Created on Wed Jun  5 10:55:46 2019
...
from OccupancyGrid.Agents.DerivedOccupancyGridAgent import MultipleSourceDetectingGridAgentWithBattery
...
from Utils.Battery import RAVBatterySimulator
...
#    agent3_name = 'agent3'
    ...
    assert all([charging_location in grid.get_grid_points() for charging_location in charging_locations])
